...
public class PictureViewer extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(getIntent().getStringExtra("FromPictureEditor") == "1111")
		{
			temperature.setText(String.valueOf(getIntent().getStringExtra("locTemp")));
			location.setText(String.valueOf(getIntent().getStringExtra("gpsLocation")));
			timeStamp.setText(String.valueOf(getIntent().getStringExtra("timeStamp")));
			altitude.setText(String.valueOf(getIntent().getStringExtra("locAltitude")));
			caption.setText(String.valueOf(getIntent().getStringExtra("photoCaption")));	
		}
		else
		{
